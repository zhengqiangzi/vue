...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return vueFormConfig; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return vueFormState; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__util__ = __webpack_require__(1);


var vueFormConfig = 'VueFormProviderConfig' + __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__util__["e" /* randomId */])();
var vueFormState = 'VueFormProviderState' + __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__util__["e" /* randomId */])();
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["g"] = getClasses;
/* harmony export (immutable) */ __webpack_exports__["i"] = addClass;
/* harmony export (immutable) */ __webpack_exports__["h"] = removeClass;
/* harmony export (immutable) */ __webpack_exports__["a"] = vModelValue;
/* harmony export (immutable) */ __webpack_exports__["d"] = getVModelAndLabel;
/* harmony export (immutable) */ __webpack_exports__["b"] = getName;
/* harmony export (immutable) */ __webpack_exports__["f"] = hyphenate;
/* harmony export (immutable) */ __webpack_exports__["e"] = randomId;
...
function getClasses(classConfig, state) {
  ...
  return _ref = {}, _defineProperty(_ref, classConfig.dirty, state.$dirty), _defineProperty(_ref, classConfig.pristine, state.$pristine), _defineProperty(_ref, classConfig.valid, state.$valid), _defineProperty(_ref, classConfig.invalid, state.$invalid), _defineProperty(_ref, classConfig.touched, state.$touched), _defineProperty(_ref, classConfig.untouched, state.$untouched), _defineProperty(_ref, classConfig.pending, state.$pending), _ref;
}
...
var config = {
  validators: __WEBPACK_IMPORTED_MODULE_0__validators__["a" /* validators */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_vue_form__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_messages__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_validate__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_field__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__directives_vue_form_validator__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_extend__ = __webpack_require__(4);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__providers__ = __webpack_require__(0);
...
function VueFormBase(options) {
  ...
  var c = __WEBPACK_IMPORTED_MODULE_5_extend___default()(true, {}, __WEBPACK_IMPORTED_MODULE_6__config__["a" /* config */], options);
  this.provide = _defineProperty({}, __WEBPACK_IMPORTED_MODULE_7__providers__["a" /* vueFormConfig */], c);
  this.components = (_components = {}, _defineProperty(_components, c.formComponent, __WEBPACK_IMPORTED_MODULE_0__components_vue_form__["a" /* default */]), _defineProperty(_components, c.messagesComponent, __WEBPACK_IMPORTED_MODULE_1__components_messages__["a" /* default */]), _defineProperty(_components, c.validateComponent, __WEBPACK_IMPORTED_MODULE_2__components_validate__["a" /* default */]), _defineProperty(_components, c.fieldComponent, __WEBPACK_IMPORTED_MODULE_3__components_field__["a" /* default */]), _components);
  this.directives = { vueFormValidator: __WEBPACK_IMPORTED_MODULE_4__directives_vue_form_validator__["a" /* default */] };
}

var VueForm = function (_VueFormBase) {
  _inherits(VueForm, _VueFormBase);

  function VueForm() {
    _classCallCheck(this, VueForm);

    return _possibleConstructorReturn(this, (VueForm.__proto__ || Object.getPrototypeOf(VueForm)).apply(this, arguments));
  }

  _createClass(VueForm, null, [{
    key: 'install',
...
/* harmony default export */ __webpack_exports__["default"] = (VueForm);
...
var _vueForm = __webpack_require__(7);
...
var app = new _vue2.default({
  ...
  components: {
    ...
    "mad-feature": __webpack_require__(30),
    "mad-edit-feature": __webpack_require__(39)
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__util__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__providers__ = __webpack_require__(0);



/* harmony default export */ __webpack_exports__["a"] = ({
  inject: { vueFormConfig: __WEBPACK_IMPORTED_MODULE_1__providers__["a" /* vueFormConfig */] },
  render: function render(h) {
    var foundVnodes = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__util__["d" /* getVModelAndLabel */])(this.$slots.default);
    ...
    if (vModelnodes.length) {
      if (this.autoLabel) {
        var id = vModelnodes[0].data.attrs && vModelnodes[0].data.attrs.id || 'vf' + __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__util__["e" /* randomId */])();
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__providers__ = __webpack_require__(0);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  inject: { vueFormConfig: __WEBPACK_IMPORTED_MODULE_0__providers__["a" /* vueFormConfig */], vueFormState: __WEBPACK_IMPORTED_MODULE_0__providers__["b" /* vueFormState */] },
  render: function render(h) {
    var _this = this;
...
/* harmony default export */ __webpack_exports__["a"] = ({
  render: function render(h) {
    ...
    if (vModelnodes.length) {
      this.name = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__util__["b" /* getName */])(vModelnodes[0]);
  ...
  inject: { vueFormConfig: __WEBPACK_IMPORTED_MODULE_1__providers__["a" /* vueFormConfig */], vueFormState: __WEBPACK_IMPORTED_MODULE_1__providers__["b" /* vueFormState */] },
  data: function data() {
    return {
      name: '',
      formstate: null,
  ...
  methods: {
    getClasses: function getClasses(classConfig) {
      var s = this.fieldstate;
      return Object.keys(s.$error).reduce(function (classes, error) {
        classes[classConfig.invalid + '-' + __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__util__["f" /* hyphenate */])(error)] = true;
        return classes;
      }, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__util__["g" /* getClasses */])(classConfig, s));
    }
  },
  computed: {
      ...
      var _loop = function _loop(i, el) {
        if (oldValue) {
          Object.keys(oldValue).filter(function (k) {
            ...
            return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__util__["h" /* removeClass */])(el, k);
          });
        }
        out = [];
        Object.keys(value).filter(function (k) {
          ...
          out.push(k);
          __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__util__["i" /* addClass */])(el, k);
        });
      };
  ...
  created: function created() {
    ...
    this.fieldstate = {
      ...
      _className: null,
      _id: 'vf' + __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__util__["e" /* randomId */])(),
      ...
      _validate: function _validate(vnode) {
        ...
        var value = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__util__["a" /* vModelValue */])(vnode.data);
        _val = value;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_extend__ = __webpack_require__(4);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  inject: { vueFormConfig: __WEBPACK_IMPORTED_MODULE_2__providers__["a" /* vueFormConfig */] },
  provide: function provide() {
    return _defineProperty({}, __WEBPACK_IMPORTED_MODULE_2__providers__["b" /* vueFormState */], this.state);
  },
  created: function created() {
    var _this2 = this;
  ...
  computed: {
    className: function className() {
      ...
      var s = this.state;
      var classes = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__util__["g" /* getClasses */])(c, s);
...
"use strict";
/* unused harmony export compareChanges */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__config__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__util__ = __webpack_require__(1);
...
function compareChanges(vnode, oldvnode, validators) {
  ...
  if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__util__["a" /* vModelValue */])(vnode.data) !== __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__util__["a" /* vModelValue */])(oldvnode.data)) {
    out.vModel = true;
    hasChanged = true;
  }
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  bind: function bind(el, binding, vnode) {
    ...
    var attrs = vnode.data.attrs || {};
    var inputName = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__util__["b" /* getName */])(vnode);
    ...
    if (attrs.debounce) {
      debouncedValidators[fieldstate._id] = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__util__["c" /* debounce */])(function (fieldstate, vnode) {
...
null);
Component.options.__file = "C:\\Users\\johnny\\Desktop\\vue\\vue\\components\\feature.component.vue";
...
if (Component.options.functional) {
  console.error("[vue-loader] feature.component.vue: functional components are not supported with templates, they should use render functions.");
}
...
if (false) {
  (function () {
    ...
    module.hot.accept();
    if (!module.hot.data) {
      hotAPI.createRecord("data-v-3bc6d643", Component.options);
    } else {
      hotAPI.reload("data-v-3bc6d643", Component.options);
    }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', _vm._l((_vm._user), function(item) {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-3bc6d643", module.exports)
  }
}
...
var update = __webpack_require__(38)("04b8fed0", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-3bc6d643\",\"scoped\":false,\"hasInlineConfig\":false}!../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./feature.component.vue", function() {
     var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-3bc6d643\",\"scoped\":false,\"hasInlineConfig\":false}!../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./feature.component.vue");
...
/* moduleIdentifier (server only) */
null);
Component.options.__file = "C:\\Users\\johnny\\Desktop\\vue\\vue\\components\\editFeature.component.vue";
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {
  return key !== "default" && key.substr(0, 2) !== "__";
})) {
  console.error("named exports are not supported in *.vue files.");
...
if (Component.options.functional) {
  console.error("[vue-loader] editFeature.component.vue: functional components are not supported with templates, they should use render functions.");
}
...
if (false) {
  (function () {
    ...
    module.hot.accept();
    if (!module.hot.data) {
      hotAPI.createRecord("data-v-2feb3f59", Component.options);
    } else {
      hotAPI.reload("data-v-2feb3f59", Component.options);
    }
    module.hot.dispose(function (data) {
      disposed = true;
    });
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-2feb3f59", module.exports)
  }
}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(38)("57abbd92", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-2feb3f59\",\"scoped\":false,\"hasInlineConfig\":false}!../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./editFeature.component.vue", function() {
     var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-2feb3f59\",\"scoped\":false,\"hasInlineConfig\":false}!../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./editFeature.component.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
